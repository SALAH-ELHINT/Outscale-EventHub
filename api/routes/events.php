...
Route::middleware(['auth:sanctum'])->prefix('events')->name('events.')->group(function () {
    ...
    Route::get('/events/{eventId}/participants', [EventParticipantController::class, 'index']);
    Route::get('/events/{eventId}/participants/{participantId}', [EventParticipantController::class, 'show']);
    Route::put('/events/{eventId}/participants/{participantId}/status', [EventParticipantController::class, 'updateStatus']);
